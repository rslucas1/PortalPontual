...
<input type="checkbox" id="btn-menu"> 
		...
		<label
			for="btn-menu" alt="" class="menu-botao">
		</label>
	...
	<ul id="ul-principal">
		...
		<li class="li-principal"><a class="linkMenu bt1"
			href="javascript://">Consulta
				<div class="caret"></div>
		</a></li>
...
<!-- 				href="consPositivacao">Positivações</a></li> -->
		...
		<ul class="ul-relatorios">
			...
			<li class="li-planoCobertura"><a class="linkMenu"
				href="despesas">Analise Adm</a></li>
			<li class="li-planoCobertura"><a class="linkMenu"
