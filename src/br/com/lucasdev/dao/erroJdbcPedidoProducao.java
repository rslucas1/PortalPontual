...
//				"LEFT JOIN evento ev ON ev.nu_ped=p.nu_ped and ev.cd_fila='ENTR' AND ev.cd_emp=13 AND ev.situacao!='CA'\r\n" + 
//				"where p.cd_emp = 13\r\n" + 
//				"AND e.cd_fila ='SEPA'\r\n" + 
//				"AND C.tp_end = 'FA'\r\n" + 
