...
//
//public class JdbcPedidosDiarioOold {
//	private Connection conectionSqlServer;
//    LocalDate hoje = LocalDate.now();
//	
//	public JdbcPedidosDiarioOold (){
//		
//	try {
...
//				"	p.cd_emp=13  and\r\n" + 
//				"	p.tp_ped not in ('PE','NP', 'MD', 'VA') AND \r\n" + 
//				"   p.situacao NOT IN ('CA')";
//		
//				System.out.println(sql);
//		
//		try {
//			PreparedStatement stmt = (PreparedStatement) connectionSqlServer.prepareStatement(sql);
